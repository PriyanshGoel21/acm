                    ...
                    for obj in data["objects"]:
                        if (
                            ...
                            try:
                                ...
                                embed.add_field(name="Organizer", value=obj['host'], inline=False)
                                embed.add_field(name="Time", value=f"<t:{int(event.start_time.timestamp())}:f>",
                                                inline=False)
                                embed.set_author(name="Click here to get reminded", url=event.url)
                                embeds.append(embed)
